...
import { AlertCircle, ChevronDown, ChevronUp, Clock, FileText } from 'lucide-react';
    ...
    return (
        <SectionWrapper id="rules" title="Event Rules" subtitle="Please follow these guidelines strictly">
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <GlassCard className="border-neon-pink/30 relative overflow-hidden">
                    ...
                    <div className="flex items-start gap-4 p-2">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-xl font-bold text-white">General Regulations</h3>
                ...
                {/* Duration Rules - Expandable */}
                <GlassCard className="border-neon-purple/30 group cursor-pointer" onClick={() => setIsDurationExpanded(!isDurationExpanded)}>
                    <div className="flex justify-between items-center p-2">
                        <div className="flex items-center gap-4">
                            <div className="p-3 rounded-full bg-neon-purple/10 text-neon-purple shrink-0">
                                <Clock className="w-6 h-6" />
                            </div>
                            <h3 className="text-xl font-bold text-white group-hover:text-neon-purple transition-colors">Song Duration Rules!!!</h3>
                        </div>
                    ...
                    <AnimatePresence>
                        {isDurationExpanded && (
                            ...
                            >
                                <div className="pt-4 pl-[4.5rem] pb-2 border-t border-white/10 mt-4">
                                    <ul className="space-y-3 text-gray-300">
